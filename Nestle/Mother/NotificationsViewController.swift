...
class NotificationsViewController: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    @IBOutlet weak var filterDataGot: UISegmentedControl!
    var timer : Timer!
    override func viewDidLoad() {
        super.viewDidLoad()
        
        
        self.filterDataGot.layer.cornerRadius = filterDataGot.bounds.height/2
        self.filterDataGot.layer.masksToBounds = true
        self.filterDataGot.layer.borderWidth = 1.0
        self.filterDataGot.layer.borderColor = #colorLiteral(red: 0.7975881696, green: 0.6346347332, blue: 0.233198911, alpha: 1)
      ...
      //  designFooter()
        ...
        let  _ = APIManager.shared.fetchShoutMotherApi()
            .done{
                shouty in
        ...
        filterDataGot.setTitle(("shoutouts").localiz(), forSegmentAt: 0)
        
        filterDataGot.setTitle(("main_notifications").localiz(), forSegmentAt: 1)
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        let Dvc = Storyboard.instantiateViewController(withIdentifier: "NotificationDetailViewController") as! NotificationDetailViewController
